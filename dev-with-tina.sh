#!/bin/bash
# dev-with-tina.sh - Start dev server with proper TinaCMS environment

echo "🦙 Starting TinaCMS dev server..."
...
echo "LOCAL_MODE: $TINA_PUBLIC_IS_LOCAL"
